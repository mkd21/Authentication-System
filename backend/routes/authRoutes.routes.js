...
import { signUp , login , logout , sendVerificationOtp , verifyAccount , isAuthenticated  , sendResetOtp , resetPassword} from "../controllers/auth.controller.js";
...
router.route("/reset-password-otp").post(sendResetOtp);
